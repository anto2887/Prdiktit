        ...
        <div className="px-6 py-4 border-b border-gray-200">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex flex-col items-center md:flex-row md:items-center md:space-x-4 text-center md:text-left">
              <div className="h-14 w-14 rounded-full bg-blue-100 flex items-center justify-center text-xl font-semibold text-blue-600">
                {initial}
              </div>
            ...
            <div>
              ...
              <dl className="mt-2 divide-y divide-gray-200">
                <div className="py-3 flex flex-col sm:flex-row sm:justify-between sm:items-center">
                  ...
                  <dd className="text-sm text-gray-900 mt-1 sm:mt-0">{profile?.username}</dd>
                </div>
                <div className="py-3 flex flex-col sm:flex-row sm:justify-between sm:items-center">
            ...
            <div>
              ...
              <dl className="mt-2 grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="px-4 py-5 bg-gray-50 shadow rounded-lg overflow-hidden">
                  ...
                  <dd className="mt-1 text-2xl md:text-3xl font-semibold text-gray-900">
